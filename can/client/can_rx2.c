...
int main(int argc, char **argv)
{
    ...
    volatile double mean_timediff = 0.0;
    double M2_timediff = 0.0;
    volatile double variance_timediff = 0.0;
    volatile double mean_dropped = 0.0;
    double M2_dropped = 0.0;
    volatile double variance_dropped = 0.0;
    volatile double total_timediff = 0.0;
    volatile double total_square_timediff = 0.0;
    volatile double total_dropped = 0.0;
    volatile double total_square_dropped = 0.0;
