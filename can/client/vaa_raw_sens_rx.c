...
typedef struct {
	...
	short longitudinal;	// +/-10000 	
	short vertical;		// +/-10000 	
	short lateral;		// +/-10000 	
	unsigned char thread_counter;   // changes about every 0.5 ms
	unsigned char sensor_group_counter; // same for all 10 sensors
} save_data_t;
