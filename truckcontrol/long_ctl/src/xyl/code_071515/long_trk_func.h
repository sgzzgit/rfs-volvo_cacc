...
extern int maneuver(float, float, float, float *,float *, float *, road_info_typ*, control_config_typ* , control_state_typ* , sens_read_typ*, vehicle_info_typ* , fault_index_typ *, /*int,*/ int*, manager_cmd_typ*, pltn_info_typ*);         
...
extern int cacc(float, float, int*, jbus_read_typ*, manager_cmd_typ*, control_config_typ*, control_state_typ*, switch_typ*, vehicle_info_typ*,con_output_typ*);    
extern void v_flt( float, float, /*int,*/ float, float, float, float*, fault_index_typ*);                   
extern float gear_tbl(float);
extern void est_dist( float, sens_read_typ*, control_state_typ*, int*, int*, fault_index_typ*, int);
extern void mag_dist( float,  float, sens_read_typ*, control_state_typ*, float *, float *, float *);
extern int ref_dist_1(float, int*, sens_read_typ*, vehicle_info_typ*, manager_cmd_typ*, fault_index_typ*, control_state_typ*, control_config_typ*, pltn_info_typ*);  
...
extern int comm(float, float *, float, control_state_typ*, vehicle_info_typ*, comm_info_typ*, fault_index_typ*, 
				veh_comm_packet_t*, veh_comm_packet_t*, pltn_info_typ*);
extern int read_sw(long_vehicle_state *, switch_typ*);
extern int read_jbus(float,long_vehicle_state *,long_params *,jbus_read_typ *, sens_read_typ*, switch_typ *);
...
extern int actuate(long_output_typ*, con_output_typ*, control_state_typ*, 
				    long_params*, 
                   long_output_typ*, manager_cmd_typ*, switch_typ*, jbus_read_typ*, control_config_typ*);
