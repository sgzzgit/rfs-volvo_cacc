   ...
   // From veh_long.h
    ...
    if( test_site == RFS )
       ...
       { 
         ...
         config.max_dcc=MAX_DCC;    
	     if (config_pt-> task == 0)   // DetermineMax_spd from realtime.ini
	       {   
         ...
         if (config_pt-> task == 1)            // task 2
           {	
	            con_state. des_f_dist=10.0;        		     		          		 		         	
          	    config.max_spd=(55.0)*0.4469;           		 	 
           }
         if (config_pt-> task == 2)            // task 3
           {	                                 		
          		con_state. des_f_dist=8.0;           		  		         	
          	    config.max_spd=(55.0)*0.4469;    
           }
         if (config_pt-> task == 3)            // task 4
           {	                                 		
...
if( config.run_data == TRUE ) {
        ...
        fprintf(pout, "%4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f ",               
             ...
             con_state_pt-> des_f_dist,         //manu_speed,         //47
