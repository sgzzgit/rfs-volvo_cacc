...
#define T_GAP				1.5     //[s]
#define MIN_CONTR_SPD		4.47	//[m/s]	~ 10[mph] ~ 16.09[k/hr]	
...
typedef struct
{
        ...
        float radar_rg;			// for Volvo XPC-sensor fusion
        float radar_rt;			// for Volvo XPC-sensor fusion
        float mag_space;
        float mag_range;
...
}target_read_typ;			            // read externally fused sensor data from Volvo X-PC
...
}sens_read_typ;			                // directly sensor data reading
