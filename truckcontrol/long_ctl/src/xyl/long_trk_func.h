...
extern int actuate(long_output_typ*, float*, float*, /*int*,*/ int *, con_output_typ*, control_state_typ*, 
				   control_config_typ*, control_config_typ*, long_params*, float*,
                   long_output_typ*, manager_cmd_typ*, switch_typ*, vehicle_info_typ*, jbus_read_typ*);
