...
extern int coording(float, float, control_state_typ*, control_config_typ*, f_mode_comm_typ*, vehicle_info_typ*, manager_cmd_typ*);
extern int maneuver(float, float, float, float *,float *, float *, road_info_typ*, control_config_typ* , control_state_typ* , vehicle_info_typ* , fault_index_typ *, int, int*);         
...
extern int rd_grade(int, vehicle_info_typ* , local_gps_typ * , road_info_typ * );
