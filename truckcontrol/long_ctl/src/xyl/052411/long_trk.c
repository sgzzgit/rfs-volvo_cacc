  ...
  if( test_site == NVD )
    { 
       ...
       if (config_pt-> task == 10)                                                  // Grading in two directions
        ...
        if (config.max_spd > 53.0*mph2mps)               // Protection in [m/s]
           config.max_spd=53.0*mph2mps;
	     ...
	     if (test_site == NVD)
	     {
	           ...
	           {                           		
          			...
          			if (vehicle_info_pt -> run_dist < 2200.0)         	
          	    		config.max_spd=(40.0)*mph2mps; 
          	    	else if    (vehicle_info_pt -> run_dist < 3000.0)
          	    		config.max_spd=(35.0)*mph2mps;
          	   		else if    (vehicle_info_pt -> run_dist < 4000.0)
...
{ 
   ...
   if (vehicle_info_pt-> pltn_size >= 1)       
    ...
    if ( (maneuver_des == 29) && ((con_state_pt-> pre_v < 7.0) || (v < 7.0))) 
         		maneuver_id[0] = 30;
