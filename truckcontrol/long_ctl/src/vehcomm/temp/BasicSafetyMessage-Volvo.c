...
CaccData ::= SEQUENCE {
    ...
    fwrdAcc     [15]OCTET STRING (SIZE(2)), -- PinPoint Forward Acceleration mm/s^2, (I16), 2-Byte Signed Int., getBodyAcceleration: Method ID =18
    ...
    userDI1     [39]OCTET STRING (SIZE(4)) OPTIONAL,    -- User Defined integer 1 
    userDI2     [40]OCTET STRING (SIZE(4)) OPTIONAL,    -- User Defined integer 2 
    userDF1     [41]OCTET STRING (SIZE(4)) OPTIONAL,    -- User Defined float 1 
    userDF2     [42]OCTET STRING (SIZE(4)) OPTIONAL,    -- User Defined float 2 
    userDF3     [43]OCTET STRING (SIZE(4)) OPTIONAL,     -- User Defined float 3 
    utcTime     [44]DDateTime OPTIONAL   -- time with mSec precision
    -- [4] GPS Quality?
}
