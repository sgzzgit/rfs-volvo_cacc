...
/*
 unsigned char TSC1_E_T_TSC1EMSTECU_EnOvrdCtrlM;
  unsigned char TSC1_E_T_TSC1EMSTECU_EnRSpdCtrlC;
  unsigned char TSC1_E_T_TSC1EMSTECU_EnRSpdSpdLm;
  unsigned char TSC1_E_T_TSC1EMSTECU_EnRTrqTrqLm;
  unsigned char TSC1_E_T_TSC1EMSTECU_OvrdCtrlMPr;
  unsigned char TSC1_ER_T_TSC1EMSrTECU_EnOvrdCtrlM;
  unsigned char TSC1_ER_T_TSC1EMSrTECU_EnRSpdCtrlC;
  unsigned char TSC1_ER_T_TSC1EMSrTECU_EnRSpdSpdLm;
  unsigned char TSC1_ER_T_TSC1EMSrTECU_EnRTrqTrqLm;
  unsigned char TSC1_ER_T_TSC1EMSrTECU_OvrdCtrlMPr;
  unsigned char TSC1_ER_V_TSC1ER_V_EnOvrdCtrlM;
  unsigned char TSC1_ER_V_TSC1ER_V_EnRSpdCtrlC;
  unsigned char TSC1_ER_V_TSC1ER_V_EnRSpdSpdLm;
  unsigned char TSC1_ER_V_TSC1ER_V_EnRTrqTrqLm;
  unsigned char TSC1_ER_V_TSC1ER_V_OvrdCtrlMPr;

  unsigned char TSC1EMSACC_EnOvrdCtrlM;
  unsigned char TSC1EMSACC_EnRSpdCtrlC;
  unsigned char TSC1EMSACC_OvrdCtrlMPr;
  unsigned char TSC1EMSACC_EnRSpdSpdLm;
  unsigned char TSC1EMSACC_EnRTrqTrqLm;

  unsigned char TSC1ERACC_EnOvrdCtrlM;
  unsigned char TSC1ERACC_EnRSpdCtrlC;
  unsigned char TSC1ERACC_OvrdCtrlMPr;
  unsigned char TSC1ERACC_EnRSpdSpdLm;
  unsigned char TSC1ERACC_EnRTrqTrqLm;
...
int ready_to_send_engine_src_acc (long_output_typ *ctrl, jbus_cmd_type *cmd) 
{
	...
	j1939_tsc1_e_acc_typ *tsc_e_acc = &cmd->cmd.tsc1;
	int new_mode = ctrl->engine_command_mode;
	int old_mode = tsc_e_acc->TSC1EMSACC_EnOvrdCtrlM;
...
int ready_to_send_engine_retarder_src_acc (long_output_typ *ctrl, jbus_cmd_type *cmd) 
{
	...
	int old_mode = tsc_er_acc->TSC1ERACC_EnOvrdCtrlM;
		...
		char *brake_file, char *trans_file)
{
	...
	for (i = 0; i < NUM_JBUS_SEND; i++) {
		...
		case JBUS_SEND_ENGINE_SRC_ACC:
			...
			tsc->src_address = J1939_ADDR_ACC;
			break;
		case JBUS_SEND_ENGINE_RETARDER_SRC_ACC:
			pm->slot_number = 12;
