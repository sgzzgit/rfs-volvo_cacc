/**\file 
 *	Utility functions for Linux and QNX6 based on PATH/AVCS QNX4 sys_rt.c 
 ...
 *
 *	Causes further arrivals of SIGALRM to be ignored.	
 *
...
#ifdef __CYGWIN__
/**
 * 	Put in stub for clock_settime.
 *	There is a prototype in /usr/include/time.h, but causes
 *	linker error.
 */
int clock_settime(clockid_t clk_id, const struct timespec *tp)
{
	fprintf(stderr, "No clock_settime on CYGWIN\n");
	fflush(stderr);
	return -1;
}
#endif
